...
const registerUser = asyncHandler( async(req, res) => {
    ...
    //upload on cloudinary ,if avatar uploaded on the avatar
    // create user object - create entry in db
    // remove password and refresh token from response
    // check for user creation
    //remove password and refresh token field from response we get from the db
    // return response
    //check for user creation 
    //return res;
    ...
    ////we can do the same with map ,but problem with map is that return kya kr rhe ho ,aur sb pe returned hai aur final returned hai..ye sb hme check krna hoga..Early Exit: some stops iterating through the array and returns true as soon as it finds the first element that satisfies the condition. This means that if an empty or whitespace-only field is found early in the array, the iteration stops immediately, and the rest of the fields are not processed unnecessarily.
            ...
            $lookup: {
                ...
                pipeline: [
                    ...
                    },
                    {
                        $addFields: {
                            owner: {
                                $first: "$owner"  //owner is a array of object ,we fetch the first element from that array
                            }
                        }
                    }
                ]
